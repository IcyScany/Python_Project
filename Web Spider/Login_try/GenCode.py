...
class YDCap:
    def __init__(self):
        ...
        self.model = cv2.imread(r"D:\2Work WARNING!!!\Learning Material\Python\bjjjj\Login_try/yd.yq")
    ...
    def gen_code(self, img):  # -> code
        ...
        ret, _, _ = cv2.findContours(code_thres, cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
